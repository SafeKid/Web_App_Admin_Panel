...
const rows = [
  createData('2020-02-01', 'Ayesha Perera', 1),
  createData('2020-03-09', 'Amaya Fonseka', 2),
  createData('2020-04-04', 'Akila Wijesinghe',3),
  createData('2020-05-07','Ayoma Bandara', 4),
  createData('2020-06-05', 'Sidath Samaranayake',5),
  createData('2020-02-17','Nayana Nishavi', 6),
  createData('2020-07-09', 'Nayani De Silva', 7),
  createData('2020-02-05','Monashi Perera', 8)
];
...
const headCells = [
  ...
  { id: 'Protein', numeric: true, disablePadding: false, label: 'Parent Name' },
  { id: 'Proteins', numeric: true, disablePadding: false, label: 'Serial Number' }
];
...
export default function EnhancedTable() {
  ...
  const handleConfirm = (numSelected) => {
    if(numSelected>0)
    alert("Confirmed")
  };
